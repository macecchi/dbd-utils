...
const en: TranslationKeys = {
  ...
  'landing.buildRequestsTitle': 'Build requests',
  'landing.buildRequestsDesc': 'Donors pay a little extra to choose the build — perks, addons, or a theme — for the character they request. It shows as a badge on the queue card.',
  'landing.multiRequestTitle': 'Multiple requests per donation',
  'landing.multiRequestDesc': 'One donation above your minimum can carry several characters at once. The AI splits them into separate queue entries automatically.',
