const ptBR = {
  ...
  'landing.buildRequestsTitle': 'Pedidos com build',
  'landing.buildRequestsDesc': 'Doadores pagam um extra para escolher a build — perks, addons ou um tema — do personagem que pedem. Aparece como um selo no card da fila.',
  'landing.multiRequestTitle': 'Vários pedidos por donate',
  'landing.multiRequestDesc': 'Um donate acima do seu mínimo pode trazer vários personagens de uma vez. A IA separa cada um em um pedido na fila automaticamente.',
